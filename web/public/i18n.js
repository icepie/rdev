(function () {
  const dictionaries = {
    en: {
      ...
      'index.androidDownloadLabel': 'Android downloads (mirrors tried first)',
      'index.androidDownloadNote': 'APK is the controlled phone endpoint; architecture buttons are Android CLI clients.',
    ...
    zh: {
      ...
      'index.androidDownloadLabel': 'Android 下载（自动优先尝试镜像）',
      'index.androidDownloadNote': 'APK 是手机被控端；架构按钮为 Android 命令行客户端。',
