...
class Settings {
    constructor(webSocket) {
        ...
        this.pointer_backend_select = document.getElementById("pointer_backend_select");
        this.keyboard_backend_select = document.getElementById("keyboard_backend_select");
    ...
    update_input_options(options, pointerOptions, keyboardOptions) {
    ...
    refresh_backend_select(select, options) {
        ...
        if (typeof event.data == "string") {
            ...
            if (typeof msg == "string") {
                ...
                if ("CapturableList" in msg)
                    ...
                    settings.update_input_options(capabilities["options"] || [], capabilities["pointerOptions"], capabilities["keyboardOptions"]);
                }
            }
            return;
        }
